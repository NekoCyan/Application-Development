...
export default function Component({
	...
	const [fields, setFields] = useState<{
		...
		inStock: props.searchParams.inStock ?? '1',
		page: 1,
	});
	...
	return (
		<Container className='my-5'>
			<div>
				<div className='flex flex-col justify-center gap-3 md:flex-row md:justify-start items-center align-middle'>
					...
					<div className='form-group col-md-6 col-sm-12 flex justify-center items-center gap-2'>
						...
						<div className='flex flex-row gap-5 justify-center items-center'>
							...
							<span className='text-1xl text-bold'>
								from - to
							</span>
